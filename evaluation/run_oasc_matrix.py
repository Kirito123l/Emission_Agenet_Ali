...
GROUP_CONFIGS: List[Dict[str, Any]] = [
    ...
    {
        "name": "D",
        "desc": "ExecutionReadiness under minimal priors",
        "env": {
            "ENABLE_AO_AWARE_MEMORY": "true",
            "ENABLE_SESSION_STATE_BLOCK": "false",
            "ENABLE_AO_CLASSIFIER_RULE_LAYER": "true",
            ...
            "ENABLE_RUNTIME_DEFAULT_AWARE_READINESS": "true",
            "ENABLE_LLM_INTENT_RESOLUTION": "false",
            "ENABLE_STANCE_LLM_RESOLUTION": "false",
            "ENABLE_STANCE_REVERSAL_DETECTION": "false",
        },
    },
    {
        "name": "E",
        "desc": "Full OASC + Wave 3 continuation",
        "env": {
            "ENABLE_AO_AWARE_MEMORY": "true",
            "ENABLE_SESSION_STATE_BLOCK": "false",
            "ENABLE_AO_CLASSIFIER_RULE_LAYER": "true",
    ...
    {
        "name": "F",
        "desc": "Full OASC without IntentResolution",
        "env": {
            "ENABLE_AO_AWARE_MEMORY": "true",
            "ENABLE_SESSION_STATE_BLOCK": "false",
            "ENABLE_AO_CLASSIFIER_RULE_LAYER": "true",
    ...
    {
        "name": "G",
        "desc": "Full OASC without runtime-default-aware readiness",
        "env": {
            "ENABLE_AO_AWARE_MEMORY": "true",
            "ENABLE_SESSION_STATE_BLOCK": "false",
            "ENABLE_AO_CLASSIFIER_RULE_LAYER": "true",
