...
) -> tuple[Optional[T], InfrastructureErrorType, int, Optional[str]]:
    retry_count = 0
    ...
    for attempt in range(max_retries + 1):
        try:
            ...
            if isinstance(exc, asyncio.TimeoutError):
                ...
                last_error = f"Timeout after {timeout_sec} seconds"
            else:
                    ...
                    for future in done:
                        ...
                        try:
                            ...
                            payload = {
                                ...
                                "duration_ms": 0.0,
                                "file_analysis": None,
                                "infrastructure_status": classify_infrastructure_error(exc),
                                "retry_count": 0,
                            }
                        record = _build_record_from_payload(payload)
                        logs.append(record)
